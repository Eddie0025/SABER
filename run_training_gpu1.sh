...
# CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. python3 -m saber.training.trainer --domain cyber --gpu 0
CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. python3 -m saber.training.trainer --domain architecture --gpu 0
CUDA_VISIBLE_DEVICES=1 PYTHONPATH=. python3 -m saber.training.trainer --domain meta_reasoner --gpu 0
