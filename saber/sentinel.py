    ...
    def verify_interpretation(
        ...
        *,
        ...
        prompt = (
            ...
            "Evaluate whether the compiled text accurately represents the original claims and valid math logic. "
            "Check specifically for:\n"
            "1. Technical accuracy of domain-specific content\n"
            "2. Logical reasoning and mathematical consistency\n"
            "3. Missing evidence or unsupported conclusions\n"
            "4. Any hallucinated or distorted information\n\n"
            "NOTE: Accurate mathematical calculations (e.g. Gross Profit = Revenue - COGS) must NOT be flagged as errors. "
            "If the reasoning and calculation are correct, reply ONLY with exactly 'CONFIRMED'.\n\n"
            "If there are true errors, respond ONLY with a valid JSON object (no markdown, no extra text) containing:\n"
